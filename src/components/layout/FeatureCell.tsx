...
export default function FeatureCell({ title, text }: { title: string; text: string }) {
  return (
    <div className="border-gradient-square-to-br group flex flex-col justify-center">
      <section className="flex h-full w-full flex-1 flex-col justify-center from-[#411D0A] from-20% to-secondary to-70% px-4 py-2 transition-all duration-100 group-hover:bg-gradient-to-br md:pb-12">
