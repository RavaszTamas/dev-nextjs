...
export default function SecondaryTitle({children, align = "right", textTransform="uppercase", className=""}: { children: any, align?: "left" | "right" | "center",textTransform?:string, className?:string }) {
